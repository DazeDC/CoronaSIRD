...
rule s_to_v_O80U90 {
    [#S[5] <= (vaccination_threshold * n_S5_init)] S[4] -[ 1.0 ]-> V
}

rule s_to_v_O70U80 {
    [#S[4] <= (vaccination_threshold * n_S4_init)] S[3] -[ 1.0 ]-> V
}

rule s_to_v_O60U70 {
    [#S[3] <= (vaccination_threshold * n_S3_init)] S[2] -[ 1.0 ]-> V
}

rule s_to_v_O50U60 {
    [#S[2] <= (vaccination_threshold * n_S2_init)] S[1] -[ 1.0 ]-> V
}

rule s_to_v_U50 {
    [#S[1] <= (vaccination_threshold * n_S1_init)] S[0] -[ 1.0 ]-> V
}
